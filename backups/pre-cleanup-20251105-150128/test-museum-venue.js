...
/**
 * SINGLE VENUE TEST - Museum of the Gulf Coast
...
const VENUE_ID = 3;
const VENUE_NAME = 'Museum of the Gulf Coast';
const VENUE_WEBSITE = 'http://www.museumofthegulfcoast.org/';
...
async function getVenueImagesFromGoogle() {
    ...
    try {
        ...
        const searchQuery = `${VENUE_NAME} Port Arthur Texas exterior photo`;
